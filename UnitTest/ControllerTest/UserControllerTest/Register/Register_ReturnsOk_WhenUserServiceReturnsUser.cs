...
namespace UnitTest.ControllerTest.UserControllerTest.Register
{
    public class Register_ReturnsOk_WhenUserServiceReturnsUser
    {
        private readonly Mock<IUserService> _mockUserService;
        private readonly Mock<IMapper> _mockMapper;
        private readonly UserController _controller;

        public Register_ReturnsOk_WhenUserServiceReturnsUser()
        {
